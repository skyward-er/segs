...
use egui::{Color32, CornerRadius, Id, Shape, Stroke, Ui, epaint::RectShape};
...
use crate::{
    ...
    cursor::Cursor,
    items::{ClosestElem, PlotConfig, PlotGeometry, PlotItem, PlotItemBase, add_rulers_and_text},
    label::LabelFormatter,
    math::find_closest_rect,
