...
use egui::{
    Color32, CursorIcon, Id, Layout, Painter, PointerButton, Response, Sense, Shape, Stroke, TextStyle, Ui, WidgetText,
    ecolor::Hsva, epaint,
};
use emath::{Align2, NumExt as _, Pos2, Rangef, Rect, Vec2, Vec2b, remap_clamp, vec2};

use crate::{
    axis::{Axis, AxisHints, AxisWidget, PlotTransform},
    bounds::{BoundsLinkGroups, BoundsModification, LinkedBounds, PlotBounds, PlotPoint},
    colors::rulers_color,
    cursor::{Cursor, CursorLinkGroups, PlotFrameCursors},
    grid::{GridInput, GridMark, GridSpacer},
    items,
    items::{PlotItem, Span, horizontal_line, vertical_line},
    label::LabelFormatter,
    memory::PlotMemory,
    overlays::{CoordinatesFormatter, Legend, LegendWidget},
    placement::{Corner, HPlacement, VPlacement},
};
